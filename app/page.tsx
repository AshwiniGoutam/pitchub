  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-foreground mb-6 text-balance">
              Next-Gen Platform for <span className="text-primary font-semibold"> Startups & Investors</span>
            </h1>
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto text-pretty">
              Pitchub is building a smarter way for founders and investors to connect, track, and grow together. We make
              fundraising transparent, efficient, and data-driven.
            </p>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4 text-balance">About Pitchub</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <Card className="border border-gray-100 bg-card shadow-none">
              <CardContent className="p-8">
                ...
                <h3 className="text-2xl font-bold text-card-foreground mb-3">For Founders</h3>
                <p className="text-muted-foreground text-pretty">
                  Apply to the right investors and hear back in a week—no more cold emails. Present, manage, and track
            ...
            <Card className="border border-gray-100 bg-card shadow-none">
              <CardContent className="p-8">
                ...
                <h3 className="text-2xl font-bold text-card-foreground mb-3">For Investors</h3>
                <p className="text-muted-foreground text-pretty">
                  Discover quality deal flow, track your portfolio, and make data-driven investment decisions with
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4 text-balance">
              Key Features <span className="text-muted-foreground">(Coming Soon)</span>
            </h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            <Card className="bg-background border border-gray-50 shadow-none">
              <CardContent className="p-6">
                ...
                <h3 className="text-lg font-bold text-foreground mb-2">Investor Dashboard</h3>
            ...
            <Card className="bg-background border border-gray-50 shadow-none">
              <CardContent className="p-6">
                ...
                <h3 className="text-lg font-bold text-foreground mb-2">Founder Interface</h3>
                <p className="text-sm text-muted-foreground">Simplified pitch creation & performance tracking.</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-background border border-gray-50 shadow-none">
              <CardContent className="p-6">
                ...
                <h3 className="text-lg font-bold text-foreground mb-2">Fund Tracking</h3>
                <p className="text-sm text-muted-foreground">Real-time updates on fundraising milestones.</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-background border border-gray-50 shadow-none">
              <CardContent className="p-6">
                ...
                <h3 className="text-lg font-bold text-foreground mb-2">Collaboration Tools</h3>
                <p className="text-sm text-muted-foreground">Collaboration tools, feedback loops, and reporting.</p>
              </CardContent>
            </Card>
          </div>
        </div>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4 text-balance">Why Pitchub?</h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-foreground mb-2">Transparency in Funding</h3>
              <p className="text-sm text-muted-foreground text-pretty">
                Clear visibility into the fundraising process with real-time updates and honest feedback from investors.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-foreground mb-2">Saves Time</h3>
              <p className="text-sm text-muted-foreground text-pretty">
                Streamlined processes for both founders and investors, eliminating inefficient cold outreach.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground text-pretty">
                Not just data, but meaningful insights that help make better investment and fundraising decisions.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground text-pretty">
                Built for the next generation of venture building with modern tools and intelligent matching.
              </p>
            </div>
          </div>
        </div>
              ...
              <CardContent className="p-8 md:p-12">
                <div className="text-center mb-8">
                  ...
                  <p className="text-lg text-muted-foreground mb-2">
                    Be the first to experience Pitchub. Join our waitlist and get notified when we launch.
                  </p>
                </div>
                ...
                <div className="flex items-center flex-wrap gap-10 justify-center mb-6">
                  ...
                  <div className="flex items-center gap-3">
                    <CheckCircle2 className="w-5 h-5 text-primary flex-shrink-0" />
                    <span className="text-muted-foreground">Exclusive features preview</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckCircle2 className="w-5 h-5 text-primary flex-shrink-0" />
