...
export default function SubmitPitchPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        setSuccess("Pitch submitted successfully! You'll receive feedback on relevance matching.")
        setTimeout(() => {
      ...
      <div className="flex-1 overflow-auto">
        <div className="p-6">
          ...
          <div className="mb-8">
            ...
            <h1 className="text-3xl font-bold text-foreground mb-2">Submit Your Pitch</h1>
            <p className="text-muted-foreground">
              Provide details about your startup to connect with relevant investors
            </p>
          </div>
          ...
          <div className="max-w-2xl">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Fill out the form below to submit your pitch to our network of investors
                </CardDescription>
              </CardHeader>
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        <Label htmlFor="fundingMin">Minimum Funding ($) *</Label>
                        <Input
                          id="fundingMin"
                          type="number"
                          placeholder="100000"
                          value={formData.fundingMin}
                          onChange={(e) => handleInputChange("fundingMin", e.target.value)}
                          required
                        />
                      </div>

                      <div className="space-y-2">
                        <Label htmlFor="fundingMax">Maximum Funding ($) *</Label>
                        <Input
                          id="fundingMax"
                          type="number"
                          placeholder="500000"
                          value={formData.fundingMax}
                          onChange={(e) => handleInputChange("fundingMax", e.target.value)}
                          required
                        />
                      </div>
                    </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="pitchDeck">Upload Pitch Deck (PDF or PowerPoint)</Label>
                      <div className="border-2 border-dashed border-border rounded-lg p-6 text-center">
                        ...
                        <div className="space-y-2">
                          ...
                          <p className="text-xs text-muted-foreground">PDF or PowerPoint up to 10MB</p>
                          <Input
                            id="pitchDeck"
                            type="file"
                            accept=".pdf,.ppt,.pptx"
